...
class LightsTests {
    ...
    public void testGetL() {
        ...
        //  BAV - The light source is exactly on the surface of the body (point equals position)
        assertNull(pointLight.getL(new Point(1, 2, 3)),
                "getL() should handle the case where the point equals the light position gracefully");
    }
