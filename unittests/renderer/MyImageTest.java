...
public class MyImageTest {
    ...
    public void myCustomScene() {
        ...
        // Set a dark grey background (so the mirror doesn't just reflect black and disappear)
        ...
        //  Configure camera (looking straight ahead)
        ...
        scene.geometries.add(
                // Mirror floor (a giant triangle lying flat on the Y-axis at height -50)
                ...
                // Blue transparent sphere (hovering slightly above the floor)
                new Sphere(new Point(-20, 0, 50), 30D)
                        .setEmission(new primitives.Color(java.awt.Color.BLUE))
                        .setMaterial(new Material().setKD(0.2).setKS(0.2).setShininess(30).setKT(0.6)),

                // Red opaque sphere (sitting exactly on the mirror floor)
        ...
        scene.lights.add(
                // Spotlight shining from above and to the right, casting nice shadows on the left side of the floor
